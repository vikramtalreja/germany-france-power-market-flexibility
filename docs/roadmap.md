...
- [ ] Verify energy balance, efficiency losses and objective accounting on a small deterministic example.
- [ ] Compare battery capacity, efficiency and cycling-cost sensitivities.
- [ ] Add an educational network-constraint example with PTDFs and RAM.
- [ ] Publish reproducible results and then update CV/LinkedIn with completed work only.
